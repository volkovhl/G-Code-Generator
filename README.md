...
<p align="center">
  <strong>Генератор G-кода для CNC 3018 (GRBL) с поддержкой лазера, спиральной заливки и концентрических контуров</strong><br>
  Контур • Рамка • Спираль • Смещение • Лазерный режим
</p>
...
<div align="center">
  <table>
    <tr>
      <td align="center" width="110">▢ ◯ ⬡<br><b>Квадрат / Прямоугольник<br>Круг / Шестигранник</b></td>
      <td align="center" width="110">📐 🖼️<br><b>Контур • Рамка</b></td>
      <td align="center" width="110">🌀 🔘<br><b>Спираль • Смещение</b></td>
      <td align="center" width="110">🔥 🔧<br><b>Лазер • Сверление</b></td>
    </tr>
  </table>
</div>
...
- **Концентрические контуры (pocket)** — от края к центру с припуском
- **Лазерный режим** (M3/M5 + мощность S, без перемещений по Z)
- **Центровое сверление** перед заливкой (для спирали и смещения)
...
> - Для тяжёлых спиралей/контуров можно отключить визуализацию — G-code всё равно генерируется.
...
| **Рамка** | Внешний + внутренний контур с подъёмом Z между ними. Отдельные радиусы скругления и толщина стенки. |
| **Спираль (заливка)** | Заполняет всю площадь от центра к краю. Черновая спираль с припуском + чистовой контур. |
| **Смещение (контуры)** | Концентрические контуры от края к центру. Черновая обработка с припуском + чистовой проход. |
...
- **Центровое сверление** — перед началом заливки
...
- Поддержка спиральной и концентрической заливки
